  ...
  return (
    <>
      ...
      <div className="Home">
        ...
        {/* --------------------------------------------------------------------------------- */}
        <div
          className="home-get-ticket-container"
          ref={sectionRef}
          style={{ height: "40vh" }}
        >
            ...
            <div className="col-12">
              <article className="blog-card">
                ...
                <div className="blog-card__info">
                  ...
                  <p>
                    SIGN UP NOW for a seamless metro experience. Join us and
                    enjoy convenience, personalized recommendations, and
                    exclusive benefits. Start your journey today!
                  </p>
            ...
            <div className="projcard-innerbox">
              ...
              <div className="projcard-textbox">
                ...
                <div className="projcard-description">
                  Experience seamless and efficient travel with our easy-to-use
                  online booking system. Skip the long queues and effortlessly
                  reserve your metro tickets from the comfort of your home or on
                  the go.
                </div>
          ...
          >
            <div className="projcard-innerbox">
              ...
              <div className="projcard-textbox">
                ...
                <div className="projcard-subtitle">
                  Track, Modify, and Refund
                </div>
                <div className="projcard-bar"></div>
                <div className="projcard-description">
                  Stay in control of your metro rides with our user-friendly
                  ride management tools. Easily track your journey history, make
                  modifications if needed, and enjoy the flexibility of refund
          ...
          >
            <div className="projcard-innerbox">
              ...
              <div className="projcard-textbox">
                ...
                <div className="projcard-bar"></div>
                <div className="projcard-description">
                  Upgrade your metro travel experience with our subscription
                  plans. Enjoy unlimited rides, priority access, and exclusive
                  perks. Choose from monthly, quarterly, or annual subscriptions
          ...
          >
            <div className="projcard-innerbox">
              ...
              <div className="projcard-textbox">
                ...
                <div className="projcard-bar"></div>
                <div className="projcard-description">
                  Did you know that the first metro system was established in
                  London in 1863? Explore interesting facts and trivia about
                  metro systems worldwide. From historic milestones to
                  technological advancements, uncover the wonders of metro
                  transportation.
                </div>
                <div className="projcard-tagbox">
