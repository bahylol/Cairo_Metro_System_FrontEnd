                    ...
                    >
                      ...
                      <CardContent>
                        <Typography variant="body2" color="text.secondary">
                          Discover seamless travel with our subscription plans!
                          Choose from monthly, quarterly, or annual
                          subscriptions for easy access to the metro booking
                          system. Say goodbye to purchasing tickets every time
                          you travel and enjoy unlimited journeys. As a loyal
                          customer, unlock exclusive promo codes as a token of
                          our appreciation. Subscribe now and experience
                          convenience and exciting rewards!
                        </Typography>
                      </CardContent>
                          ...
                          <React.Fragment>
                            <CardContent>
                              ...
                              <Typography variant="body2">
                                ...
                                offering up to 20% savings compared to
                                individual tickets. These cost savings make them
                                an attractive option for regular metro riders
                        ...
                        <Card variant="outlined" sx={{ height: "100%" }}>
                          <React.Fragment>
                            <CardContent>
                              ...
                              <Typography variant="body2">
                                Ticket subscriptions not only save money but
                                also encourage increased public transportation
                                usage, reducing traffic congestion and promoting
                                a more sustainable urban environment. Subscribe
                                and make it easier for commuters to access and
            ...
            <div className="VSmodal">
              <div onClick={toggleRefundModal} className="VSoverlay">
                <div className="VS-modal-form">
                  ...
                  <p>
                    --Caneling, will lead to the loss of your remaining
                    ticket-usages--
                  </p>
                ...
                <div className="VS-modal-form">
                  ...
                  >
                    ...
                    <Select
                      ...
                      input={
                        <OutlinedInput label="Zones" id="demo-dialog-native" />
                      }
                    >
                      <option value={1}>
                        1 - 9{" stations/ Price: "}
