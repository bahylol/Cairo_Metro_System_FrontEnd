...
const Zones = () => {
    ...
    const columns = [
        ...
        { field: 'price', headerName: 'Price', minWidth: 100, flex: 1 },
        {
            ...
            flex: 1,
            renderCell: (params) => (
                <Button variant="contained" style={{ backgroundColor: "#da2c43" }} onClick={() => openZonesPopup(params.id)} color="primary" >
                    Update Price
                </Button>
            ),
        },
                    ...
                    <div className="VSoverlay">
                        <div className="VS-modal-form">
                            ...
                            <div className="VSmodal-Refundcolumn">
                                ...
                                <Button variant="contained" style={{ backgroundColor: "#000000" }} onClick={closeZonesPopup}>
                                    Back
                                </Button>
                                <Button variant="contained" style={{ backgroundColor: "#da2c43" }} onClick={handleChange} >
                                    confirm
                                </Button>
                            </div>
                        </div>
