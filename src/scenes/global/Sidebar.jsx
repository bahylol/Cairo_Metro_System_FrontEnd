...
const Sidebar = ({userType,isHome}) => {
  ...
  return (
<div className="MuiBox-root css-jtrkzm" style={{ width: '1000px', height: '0px' ,marginRight: '0px'}}>
{/* <div className="MuiBox-root css-ists20" style={{ width: '1000px', height: '0px' ,marginRight: '15px'}}> */}
